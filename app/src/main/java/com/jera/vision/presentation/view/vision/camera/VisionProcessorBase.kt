...
import com.jera.vision.presentation.view.vision.camera.CameraSourcePreview.isCameraLiveViewportEnabled
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    private fun processImage(
        ...
        val bitmap =
            if (isCameraLiveViewportEnabled(graphicOverlay.context)) null
...
//            )
    ...
    private fun <TResult> Task<TResult>.addOnFailureListener(
        executor: Executor,
