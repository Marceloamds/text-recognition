package com.jera.vision.presentation.util.error

import com.jera.vision.domain.entity.error.ErrorData
import com.jera.vision.domain.entity.error.HttpErrorType
